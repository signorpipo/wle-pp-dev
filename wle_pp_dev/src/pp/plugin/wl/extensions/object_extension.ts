...
export function initObjectExtensionProtoype(): void {
    ...
    objectExtension.pp_getPositionWorld = function pp_getPositionWorld(position: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getPositionWorld(this, position);
    };

    objectExtension.pp_getPositionLocal = function pp_getPositionLocal(position: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getPositionLocal(this, position);
    };

    // Rotation

    objectExtension.pp_getRotation = function pp_getRotation(rotation: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getRotation(this, rotation);
    };

    objectExtension.pp_getRotationDegrees = function pp_getRotationDegrees(rotation: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getRotationDegrees(this, rotation);
    };

    objectExtension.pp_getRotationRadians = function pp_getRotationRadians(rotation: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getRotationRadians(this, rotation);
    };

    objectExtension.pp_getRotationMatrix = function pp_getRotationMatrix(rotation: NumberArray = Mat3Utils.create()): NumberArray {
        return ObjectUtils.getRotationMatrix(this, rotation);
    };

    objectExtension.pp_getRotationQuat = function pp_getRotationQuat(rotation: NumberArray = QuatUtils.create()): NumberArray {
        return ObjectUtils.getRotationQuat(this, rotation);
    };

    // Rotation World

    objectExtension.pp_getRotationWorld = function pp_getRotationWorld(rotation: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getRotationWorld(this, rotation);
    };

    objectExtension.pp_getRotationWorldDegrees = function pp_getRotationWorldDegrees(rotation: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getRotationWorldDegrees(this, rotation);
    };

    objectExtension.pp_getRotationWorldRadians = function pp_getRotationWorldRadians(rotation: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getRotationWorldRadians(this, rotation);
    };

    objectExtension.pp_getRotationWorldMatrix = function pp_getRotationWorldMatrix(rotation: NumberArray = Mat3Utils.create()): NumberArray {
        return ObjectUtils.getRotationWorldMatrix(this, rotation);
    };

    objectExtension.pp_getRotationWorldQuat = function pp_getRotationWorldQuat(rotation: NumberArray = QuatUtils.create()): NumberArray {
        return ObjectUtils.getRotationWorldQuat(this, rotation);
    };

    // Rotation Local

    objectExtension.pp_getRotationLocal = function pp_getRotationLocal(rotation: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getRotationLocal(this, rotation);
    };

    objectExtension.pp_getRotationLocalDegrees = function pp_getRotationLocalDegrees(rotation: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getRotationLocalDegrees(this, rotation);
    };

    objectExtension.pp_getRotationLocalRadians = function pp_getRotationLocalRadians(rotation: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getRotationLocalRadians(this, rotation);
    };

    objectExtension.pp_getRotationLocalMatrix = function pp_getRotationLocalMatrix(rotation: NumberArray = Mat3Utils.create()): NumberArray {
        return ObjectUtils.getRotationLocalMatrix(this, rotation);
    };

    objectExtension.pp_getRotationLocalQuat = function pp_getRotationLocalQuat(rotation: NumberArray = QuatUtils.create()): NumberArray {
        return ObjectUtils.getRotationLocalQuat(this, rotation);
    };

    // Scale

    objectExtension.pp_getScale = function pp_getScale(scale: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getScale(this, scale);
    };

    objectExtension.pp_getScaleWorld = function pp_getScaleWorld(scale: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getScaleWorld(this, scale);
    };

    objectExtension.pp_getScaleLocal = function pp_getScaleLocal(scale: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getScaleLocal(this, scale);
    };

    // Transform

    objectExtension.pp_getTransform = function pp_getTransform(transform: NumberArray = Mat4Utils.create()): NumberArray {
        return ObjectUtils.getTransform(this, transform);
    };

    objectExtension.pp_getTransformMatrix = function pp_getTransformMatrix(transform: NumberArray = Mat4Utils.create()): NumberArray {
        return ObjectUtils.getTransformMatrix(this, transform);
    };

    objectExtension.pp_getTransformQuat = function pp_getTransformQuat(transform: NumberArray = Quat2Utils.create()): NumberArray {
        return ObjectUtils.getTransformQuat(this, transform);
    };

    // Transform World

    objectExtension.pp_getTransformWorld = function pp_getTransformWorld(transform: NumberArray = Mat4Utils.create()): NumberArray {
        return ObjectUtils.getTransformWorld(this, transform);
    };

    objectExtension.pp_getTransformWorldMatrix = function pp_getTransformWorldMatrix(transform: NumberArray = Mat4Utils.create()): NumberArray {
        return ObjectUtils.getTransformWorldMatrix(this, transform);
    };

    objectExtension.pp_getTransformWorldQuat = function pp_getTransformWorldQuat(transform: NumberArray = Quat2Utils.create()): NumberArray {
        return ObjectUtils.getTransformWorldQuat(this, transform);
    };

    // Transform Local

    objectExtension.pp_getTransformLocal = function pp_getTransformLocal(transform: NumberArray = Mat4Utils.create()): NumberArray {
        return ObjectUtils.getTransformLocal(this, transform);
    };

    objectExtension.pp_getTransformLocalMatrix = function pp_getTransformLocalMatrix(transform: NumberArray = Mat4Utils.create()): NumberArray {
        return ObjectUtils.getTransformLocalMatrix(this, transform);
    };

    objectExtension.pp_getTransformLocalQuat = function pp_getTransformLocalQuat(transform: NumberArray = Quat2Utils.create()): NumberArray {
        return ObjectUtils.getTransformLocalQuat(this, transform);
    };

    // Axes

    objectExtension.pp_getAxes = function pp_getAxes(axes: NumberArray[] = [Vec3Utils.create(), Vec3Utils.create(), Vec3Utils.create()]): NumberArray[] {
        return ObjectUtils.getAxes(this, axes);
    };

    objectExtension.pp_getAxesWorld = function pp_getAxesWorld(axes: NumberArray[] = [Vec3Utils.create(), Vec3Utils.create(), Vec3Utils.create()]): NumberArray[] {
        return ObjectUtils.getAxesWorld(this, axes);
    };

    objectExtension.pp_getAxesLocal = function pp_getAxesLocal(axes: NumberArray[] = [Vec3Utils.create(), Vec3Utils.create(), Vec3Utils.create()]): NumberArray[] {
        return ObjectUtils.getAxesLocal(this, axes);
    };

    // Forward

    objectExtension.pp_getForward = function pp_getForward(forward: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getForward(this, forward);
    };

    objectExtension.pp_getForwardWorld = function pp_getForwardWorld(forward: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getForwardWorld(this, forward);
    };

    objectExtension.pp_getForwardLocal = function pp_getForwardLocal(forward: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getForwardLocal(this, forward);
    };

    // Backward

    objectExtension.pp_getBackward = function pp_getBackward(backward: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getBackward(this, backward);
    };

    objectExtension.pp_getBackwardWorld = function pp_getBackwardWorld(backward: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getBackwardWorld(this, backward);
    };

    objectExtension.pp_getBackwardLocal = function pp_getBackwardLocal(backward: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getBackwardLocal(this, backward);
    };

    // Up

    objectExtension.pp_getUp = function pp_getUp(up: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getUp(this, up);
    };

    objectExtension.pp_getUpWorld = function pp_getUpWorld(up: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getUpWorld(this, up);
    };

    objectExtension.pp_getUpLocal = function pp_getUpLocal(up: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getUpLocal(this, up);
    };

    // Down

    objectExtension.pp_getDown = function pp_getDown(down: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getDown(this, down);
    };

    objectExtension.pp_getDownWorld = function pp_getDownWorld(down: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getDownWorld(this, down);
    };

    objectExtension.pp_getDownLocal = function pp_getDownLocal(down: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getDownLocal(this, down);
    };

    // Left

    objectExtension.pp_getLeft = function pp_getLeft(left: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getLeft(this, left);
    };

    objectExtension.pp_getLeftWorld = function pp_getLeftWorld(left: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getLeftWorld(this, left);
    };

    objectExtension.pp_getLeftLocal = function pp_getLeftLocal(left: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getLeftLocal(this, left);
    };

    // Right

    objectExtension.pp_getRight = function pp_getRight(right: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getRight(this, right);
    };

    objectExtension.pp_getRightWorld = function pp_getRightWorld(right: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.getRightWorld(this, right);
    };

    objectExtension.pp_getRightLocal = function pp_getRightLocal(right: NumberArray = Vec3Utils.create()): NumberArray {
    ...
    objectExtension.pp_setPosition = function pp_setPosition(position: NumberArray): void {
        return ObjectUtils.setPosition(this, position);
    };

    objectExtension.pp_setPositionWorld = function pp_setPositionWorld(position: NumberArray): void {
        return ObjectUtils.setPositionWorld(this, position);
    };

    objectExtension.pp_setPositionLocal = function pp_setPositionLocal(position: NumberArray): void {
        return ObjectUtils.setPositionLocal(this, position);
    };

    // Rotation

    objectExtension.pp_setRotation = function pp_setRotation(rotation: NumberArray): void {
        return ObjectUtils.setRotation(this, rotation);
    };

    objectExtension.pp_setRotationDegrees = function pp_setRotationDegrees(rotation: NumberArray): void {
        return ObjectUtils.setRotationDegrees(this, rotation);
    };

    objectExtension.pp_setRotationRadians = function pp_setRotationRadians(rotation: NumberArray): void {
        return ObjectUtils.setRotationRadians(this, rotation);
    };

    objectExtension.pp_setRotationMatrix = function pp_setRotationMatrix(rotation: NumberArray): void {
        return ObjectUtils.setRotationMatrix(this, rotation);
    };

    objectExtension.pp_setRotationQuat = function pp_setRotationQuat(rotation: NumberArray): void {
        return ObjectUtils.setRotationQuat(this, rotation);
    };

    // Rotation World

    objectExtension.pp_setRotationWorld = function pp_setRotationWorld(rotation: NumberArray): void {
        return ObjectUtils.setRotationWorld(this, rotation);
    };

    objectExtension.pp_setRotationWorldDegrees = function pp_setRotationWorldDegrees(rotation: NumberArray): void {
        return ObjectUtils.setRotationWorldDegrees(this, rotation);
    };

    objectExtension.pp_setRotationWorldRadians = function pp_setRotationWorldRadians(rotation: NumberArray): void {
        return ObjectUtils.setRotationWorldRadians(this, rotation);
    };

    objectExtension.pp_setRotationWorldMatrix = function pp_setRotationWorldMatrix(rotation: NumberArray): void {
        return ObjectUtils.setRotationWorldMatrix(this, rotation);
    };

    objectExtension.pp_setRotationWorldQuat = function pp_setRotationWorldQuat(rotation: NumberArray): void {
        return ObjectUtils.setRotationWorldQuat(this, rotation);
    };

    // Rotation Local

    objectExtension.pp_setRotationLocal = function pp_setRotationLocal(rotation: NumberArray): void {
        return ObjectUtils.setRotationLocal(this, rotation);
    };

    objectExtension.pp_setRotationLocalDegrees = function pp_setRotationLocalDegrees(rotation: NumberArray): void {
        return ObjectUtils.setRotationLocalDegrees(this, rotation);
    };

    objectExtension.pp_setRotationLocalRadians = function pp_setRotationLocalRadians(rotation: NumberArray): void {
        return ObjectUtils.setRotationLocalRadians(this, rotation);
    };

    objectExtension.pp_setRotationLocalMatrix = function pp_setRotationLocalMatrix(rotation: NumberArray): void {
        return ObjectUtils.setRotationLocalMatrix(this, rotation);
    };

    objectExtension.pp_setRotationLocalQuat = function pp_setRotationLocalQuat(rotation: NumberArray): void {
        return ObjectUtils.setRotationLocalQuat(this, rotation);
    };

    // Scale

    objectExtension.pp_setScale = function pp_setScale(scale: number | NumberArray): void {
        return ObjectUtils.setScale(this, scale);
    };

    objectExtension.pp_setScaleWorld = function pp_setScaleWorld(scale: number | NumberArray): void {
        return ObjectUtils.setScaleWorld(this, scale);
    };

    objectExtension.pp_setScaleLocal = function pp_setScaleLocal(scale: number | NumberArray): void {
        return ObjectUtils.setScaleLocal(this, scale);
    };

    // Axes    

    objectExtension.pp_setAxes = function pp_setAxes(left: NumberArray | null = null, up: NumberArray | null = null, forward: NumberArray | null = null): void {
        return ObjectUtils.setAxes(this, left, up, forward);
    };

    objectExtension.pp_setAxesWorld = function pp_setAxesWorld(left: NumberArray | null = null, up: NumberArray | null = null, forward: NumberArray | null = null): void {
        return ObjectUtils.setAxesWorld(this, left, up, forward);
    };

    objectExtension.pp_setAxesLocal = function pp_setAxesLocal(left: NumberArray | null = null, up: NumberArray | null = null, forward: NumberArray | null = null): void {
        return ObjectUtils.setAxesLocal(this, left, up, forward);
    };

    // Forward

    objectExtension.pp_setForward = function pp_setForward(forward: NumberArray, up: NumberArray | null = null, left: NumberArray | null = null): void {
        return ObjectUtils.setForward(this, forward, up, left);
    };

    objectExtension.pp_setForwardWorld = function pp_setForwardWorld(forward: NumberArray, up: NumberArray | null = null, left: NumberArray | null = null): void {
        return ObjectUtils.setForwardWorld(this, forward, up, left);
    };

    objectExtension.pp_setForwardLocal = function pp_setForwardLocal(forward: NumberArray, up: NumberArray | null = null, left: NumberArray | null = null): void {
        return ObjectUtils.setForwardLocal(this, forward, up, left);
    };

    // Backward

    objectExtension.pp_setBackward = function pp_setBackward(backward: NumberArray, up: NumberArray | null = null, left: NumberArray | null = null): void {
        return ObjectUtils.setBackward(this, backward, up, left);
    };

    objectExtension.pp_setBackwardWorld = function pp_setBackwardWorld(backward: NumberArray, up: NumberArray | null = null, left: NumberArray | null = null): void {
        return ObjectUtils.setBackwardWorld(this, backward, up, left);
    };

    objectExtension.pp_setBackwardLocal = function pp_setBackwardLocal(backward: NumberArray, up: NumberArray | null = null, left: NumberArray | null = null): void {
        return ObjectUtils.setBackwardLocal(this, backward, up, left);
    };

    // Up

    objectExtension.pp_setUp = function pp_setUp(up: NumberArray, forward: NumberArray | null = null, left: NumberArray | null = null): void {
        return ObjectUtils.setUp(this, up, forward, left);
    };

    objectExtension.pp_setUpWorld = function pp_setUpWorld(up: NumberArray, forward: NumberArray | null = null, left: NumberArray | null = null): void {
        return ObjectUtils.setUpWorld(this, up, forward, left);
    };

    objectExtension.pp_setUpLocal = function pp_setUpLocal(up: NumberArray, forward: NumberArray | null = null, left: NumberArray | null = null): void {
        return ObjectUtils.setUpLocal(this, up, forward, left);
    };

    // Down

    objectExtension.pp_setDown = function pp_setDown(down: NumberArray, forward: NumberArray | null = null, left: NumberArray | null = null): void {
        return ObjectUtils.setDown(this, down, forward, left);
    };

    objectExtension.pp_setDownWorld = function pp_setDownWorld(down: NumberArray, forward: NumberArray | null = null, left: NumberArray | null = null): void {
        return ObjectUtils.setDownWorld(this, down, forward, left);
    };

    objectExtension.pp_setDownLocal = function pp_setDownLocal(down: NumberArray, forward: NumberArray | null = null, left: NumberArray | null = null): void {
        return ObjectUtils.setDownLocal(this, down, forward, left);
    };

    // Left

    objectExtension.pp_setLeft = function pp_setLeft(left: NumberArray, up: NumberArray | null = null, forward: NumberArray | null = null): void {
        return ObjectUtils.setLeft(this, left, up, forward);
    };

    objectExtension.pp_setLeftWorld = function pp_setLeftWorld(left: NumberArray, up: NumberArray | null = null, forward: NumberArray | null = null): void {
        return ObjectUtils.setLeftWorld(this, left, up, forward);
    };

    objectExtension.pp_setLeftLocal = function pp_setLeftLocal(left: NumberArray, up: NumberArray | null = null, forward: NumberArray | null = null): void {
        return ObjectUtils.setLeftLocal(this, left, up, forward);
    };

    // Right

    objectExtension.pp_setRight = function pp_setRight(right: NumberArray, up: NumberArray | null = null, forward: NumberArray | null = null): void {
        return ObjectUtils.setRight(this, right, up, forward);
    };

    objectExtension.pp_setRightWorld = function pp_setRightWorld(right: NumberArray, up: NumberArray | null = null, forward: NumberArray | null = null): void {
        return ObjectUtils.setRightWorld(this, right, up, forward);
    };

    objectExtension.pp_setRightLocal = function pp_setRightLocal(right: NumberArray, up: NumberArray | null = null, forward: NumberArray | null = null): void {
        return ObjectUtils.setRightLocal(this, right, up, forward);
    };

    // Transform

    objectExtension.pp_setTransform = function pp_setTransform(transform: NumberArray): void {
        return ObjectUtils.setTransform(this, transform);
    };

    objectExtension.pp_setTransformMatrix = function pp_setTransformMatrix(transform: NumberArray): void {
        return ObjectUtils.setTransformMatrix(this, transform);
    };

    objectExtension.pp_setTransformQuat = function pp_setTransformQuat(transform: NumberArray): void {
        return ObjectUtils.setTransformQuat(this, transform);
    };

    // Transform World

    objectExtension.pp_setTransformWorld = function pp_setTransformWorld(transform: NumberArray): void {
        return ObjectUtils.setTransformWorld(this, transform);
    };

    objectExtension.pp_setTransformWorldMatrix = function pp_setTransformWorldMatrix(transform: NumberArray): void {
        return ObjectUtils.setTransformWorldMatrix(this, transform);
    };

    objectExtension.pp_setTransformWorldQuat = function pp_setTransformWorldQuat(transform: NumberArray): void {
        return ObjectUtils.setTransformWorldQuat(this, transform);
    };

    // Transform Local

    objectExtension.pp_setTransformLocal = function pp_setTransformLocal(transform: NumberArray): void {
        return ObjectUtils.setTransformLocal(this, transform);
    };

    objectExtension.pp_setTransformLocalMatrix = function pp_setTransformLocalMatrix(transform: NumberArray): void {
        return ObjectUtils.setTransformLocalMatrix(this, transform);
    };

    objectExtension.pp_setTransformLocalQuat = function pp_setTransformLocalQuat(transform: NumberArray): void {
    ...
    objectExtension.pp_translate = function pp_translate(translation: NumberArray): void {
        return ObjectUtils.translate(this, translation);
    };

    objectExtension.pp_translateWorld = function pp_translateWorld(translation: NumberArray): void {
        return ObjectUtils.translateWorld(this, translation);
    };

    objectExtension.pp_translateLocal = function pp_translateLocal(translation: NumberArray): void {
        return ObjectUtils.translateLocal(this, translation);
    };

    objectExtension.pp_translateObject = function pp_translateObject(translation: NumberArray): void {
        return ObjectUtils.translateObject(this, translation);
    };

    // Translate Axis

    objectExtension.pp_translateAxis = function pp_translateAxis(amount: number, direction: NumberArray): void {
        return ObjectUtils.translateAxis(this, amount, direction);
    };

    objectExtension.pp_translateAxisWorld = function pp_translateAxisWorld(amount: number, direction: NumberArray): void {
        return ObjectUtils.translateAxisWorld(this, amount, direction);
    };

    objectExtension.pp_translateAxisLocal = function pp_translateAxisLocal(amount: number, direction: NumberArray): void {
        return ObjectUtils.translateAxisLocal(this, amount, direction);
    };

    objectExtension.pp_translateAxisObject = function pp_translateAxisObject(amount: number, direction: NumberArray): void {
        return ObjectUtils.translateAxisObject(this, amount, direction);
    };

    // Rotate

    objectExtension.pp_rotate = function pp_rotate(rotation: NumberArray): void {
        return ObjectUtils.rotate(this, rotation);
    };

    objectExtension.pp_rotateDegrees = function pp_rotateDegrees(rotation: NumberArray): void {
        return ObjectUtils.rotateDegrees(this, rotation);
    };

    objectExtension.pp_rotateRadians = function pp_rotateRadians(rotation: NumberArray): void {
        return ObjectUtils.rotateRadians(this, rotation);
    };

    objectExtension.pp_rotateMatrix = function pp_rotateMatrix(rotation: NumberArray): void {
        return ObjectUtils.rotateMatrix(this, rotation);
    };

    objectExtension.pp_rotateQuat = function pp_rotateQuat(rotation: NumberArray): void {
        return ObjectUtils.rotateQuat(this, rotation);
    };

    // Rotate World

    objectExtension.pp_rotateWorld = function pp_rotateWorld(rotation: NumberArray): void {
        return ObjectUtils.rotateWorld(this, rotation);
    };

    objectExtension.pp_rotateWorldDegrees = function pp_rotateWorldDegrees(rotation: NumberArray): void {
        return ObjectUtils.rotateWorldDegrees(this, rotation);
    };

    objectExtension.pp_rotateWorldRadians = function pp_rotateWorldRadians(rotation: NumberArray): void {
        return ObjectUtils.rotateWorldRadians(this, rotation);
    };

    objectExtension.pp_rotateWorldMatrix = function pp_rotateWorldMatrix(rotation: NumberArray): void {
        return ObjectUtils.rotateWorldMatrix(this, rotation);
    };

    objectExtension.pp_rotateWorldQuat = function pp_rotateWorldQuat(rotation: NumberArray): void {
        return ObjectUtils.rotateWorldQuat(this, rotation);
    };

    // Rotate Local

    objectExtension.pp_rotateLocal = function pp_rotateLocal(rotation: NumberArray): void {
        return ObjectUtils.rotateLocal(this, rotation);
    };

    objectExtension.pp_rotateLocalDegrees = function pp_rotateLocalDegrees(rotation: NumberArray): void {
        return ObjectUtils.rotateLocalDegrees(this, rotation);
    };

    objectExtension.pp_rotateLocalRadians = function pp_rotateLocalRadians(rotation: NumberArray): void {
        return ObjectUtils.rotateLocalRadians(this, rotation);
    };

    objectExtension.pp_rotateLocalMatrix = function pp_rotateLocalMatrix(rotation: NumberArray): void {
        return ObjectUtils.rotateLocalMatrix(this, rotation);
    };

    objectExtension.pp_rotateLocalQuat = function pp_rotateLocalQuat(rotation: NumberArray): void {
        return ObjectUtils.rotateLocalQuat(this, rotation);
    };

    // Rotate Object

    objectExtension.pp_rotateObject = function pp_rotateObject(rotation: NumberArray): void {
        return ObjectUtils.rotateObject(this, rotation);
    };

    objectExtension.pp_rotateObjectDegrees = function pp_rotateObjectDegrees(rotation: NumberArray): void {
        return ObjectUtils.rotateObjectDegrees(this, rotation);
    };

    objectExtension.pp_rotateObjectRadians = function pp_rotateObjectRadians(rotation: NumberArray): void {
        return ObjectUtils.rotateObjectRadians(this, rotation);
    };

    objectExtension.pp_rotateObjectMatrix = function pp_rotateObjectMatrix(rotation: NumberArray): void {
        return ObjectUtils.rotateObjectMatrix(this, rotation);
    };

    objectExtension.pp_rotateObjectQuat = function pp_rotateObjectQuat(rotation: NumberArray): void {
        return ObjectUtils.rotateObjectQuat(this, rotation);
    };

    // Rotate Axis

    objectExtension.pp_rotateAxis = function pp_rotateAxis(angle: number, axis: NumberArray): void {
        return ObjectUtils.rotateAxis(this, angle, axis);
    };

    objectExtension.pp_rotateAxisDegrees = function pp_rotateAxisDegrees(angle: number, axis: NumberArray): void {
        return ObjectUtils.rotateAxisDegrees(this, angle, axis);
    };

    objectExtension.pp_rotateAxisRadians = function pp_rotateAxisRadians(angle: number, axis: NumberArray): void {
        return ObjectUtils.rotateAxisRadians(this, angle, axis);
    };

    // Rotate Axis World

    objectExtension.pp_rotateAxisWorld = function pp_rotateAxisWorld(angle: number, axis: NumberArray): void {
        return ObjectUtils.rotateAxisWorld(this, angle, axis);
    };

    objectExtension.pp_rotateAxisWorldDegrees = function pp_rotateAxisWorldDegrees(angle: number, axis: NumberArray): void {
        return ObjectUtils.rotateAxisWorldDegrees(this, angle, axis);
    };

    objectExtension.pp_rotateAxisWorldRadians = function pp_rotateAxisWorldRadians(angle: number, axis: NumberArray): void {
        return ObjectUtils.rotateAxisWorldRadians(this, angle, axis);
    };

    // Rotate Axis Local

    objectExtension.pp_rotateAxisLocal = function pp_rotateAxisLocal(angle: number, axis: NumberArray): void {
        return ObjectUtils.rotateAxisLocal(this, angle, axis);
    };

    objectExtension.pp_rotateAxisLocalDegrees = function pp_rotateAxisLocalDegrees(angle: number, axis: NumberArray): void {
        return ObjectUtils.rotateAxisLocalDegrees(this, angle, axis);
    };

    objectExtension.pp_rotateAxisLocalRadians = function pp_rotateAxisLocalRadians(angle: number, axis: NumberArray): void {
        return ObjectUtils.rotateAxisLocalRadians(this, angle, axis);
    };

    // Rotate Axis Object

    objectExtension.pp_rotateAxisObject = function pp_rotateAxisObject(angle: number, axis: NumberArray): void {
        return ObjectUtils.rotateAxisObject(this, angle, axis);
    };

    objectExtension.pp_rotateAxisObjectDegrees = function pp_rotateAxisObjectDegrees(angle: number, axis: NumberArray): void {
        return ObjectUtils.rotateAxisObjectDegrees(this, angle, axis);
    };

    objectExtension.pp_rotateAxisObjectRadians = function pp_rotateAxisObjectRadians(angle: number, axis: NumberArray): void {
        return ObjectUtils.rotateAxisObjectRadians(this, angle, axis);
    };

    // Rotate Around

    objectExtension.pp_rotateAround = function pp_rotateAround(rotation: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAround(this, rotation, origin);
    };

    objectExtension.pp_rotateAroundDegrees = function pp_rotateAroundDegrees(rotation: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundDegrees(this, rotation, origin);
    };

    objectExtension.pp_rotateAroundRadians = function pp_rotateAroundRadians(rotation: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundRadians(this, rotation, origin);
    };

    objectExtension.pp_rotateAroundMatrix = function pp_rotateAroundMatrix(rotation: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundMatrix(this, rotation, origin);
    };

    objectExtension.pp_rotateAroundQuat = function pp_rotateAroundQuat(rotation: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundQuat(this, rotation, origin);
    };

    // Rotate Around World

    objectExtension.pp_rotateAroundWorld = function pp_rotateAroundWorld(rotation: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundWorld(this, rotation, origin);
    };

    objectExtension.pp_rotateAroundWorldDegrees = function pp_rotateAroundWorldDegrees(rotation: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundWorldDegrees(this, rotation, origin);
    };

    objectExtension.pp_rotateAroundWorldRadians = function pp_rotateAroundWorldRadians(rotation: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundWorldRadians(this, rotation, origin);
    };

    objectExtension.pp_rotateAroundWorldMatrix = function pp_rotateAroundWorldMatrix(rotation: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundWorldMatrix(this, rotation, origin);
    };

    objectExtension.pp_rotateAroundWorldQuat = function pp_rotateAroundWorldQuat(rotation: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundWorldQuat(this, rotation, origin);
    };

    // Rotate Around Local

    objectExtension.pp_rotateAroundLocal = function pp_rotateAroundLocal(rotation: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundLocal(this, rotation, origin);
    };

    objectExtension.pp_rotateAroundLocalDegrees = function pp_rotateAroundLocalDegrees(rotation: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundLocalDegrees(this, rotation, origin);
    };

    objectExtension.pp_rotateAroundLocalRadians = function pp_rotateAroundLocalRadians(rotation: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundLocalRadians(this, rotation, origin);
    };

    objectExtension.pp_rotateAroundLocalMatrix = function pp_rotateAroundLocalMatrix(rotation: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundLocalMatrix(this, rotation, origin);
    };

    objectExtension.pp_rotateAroundLocalQuat = function pp_rotateAroundLocalQuat(rotation: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundLocalQuat(this, rotation, origin);
    };

    // Rotate Around Object

    objectExtension.pp_rotateAroundObject = function pp_rotateAroundObject(rotation: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundObject(this, rotation, origin);
    };

    objectExtension.pp_rotateAroundObjectDegrees = function pp_rotateAroundObjectDegrees(rotation: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundObjectDegrees(this, rotation, origin);
    };

    objectExtension.pp_rotateAroundObjectRadians = function pp_rotateAroundObjectRadians(rotation: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundObjectRadians(this, rotation, origin);
    };

    objectExtension.pp_rotateAroundObjectMatrix = function pp_rotateAroundObjectMatrix(rotation: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundObjectMatrix(this, rotation, origin);
    };

    objectExtension.pp_rotateAroundObjectQuat = function pp_rotateAroundObjectQuat(rotation: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundObjectQuat(this, rotation, origin);
    };

    // Rotate Around Axis

    objectExtension.pp_rotateAroundAxis = function pp_rotateAroundAxis(angle: number, axis: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundAxis(this, angle, axis, origin);
    };

    objectExtension.pp_rotateAroundAxisDegrees = function pp_rotateAroundAxisDegrees(angle: number, axis: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundAxisDegrees(this, angle, axis, origin);
    };

    objectExtension.pp_rotateAroundAxisRadians = function pp_rotateAroundAxisRadians(angle: number, axis: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundAxisRadians(this, angle, axis, origin);
    };

    // Rotate Around Axis World

    objectExtension.pp_rotateAroundAxisWorld = function pp_rotateAroundAxisWorld(angle: number, axis: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundAxisWorld(this, angle, axis, origin);
    };

    objectExtension.pp_rotateAroundAxisWorldDegrees = function pp_rotateAroundAxisWorldDegrees(angle: number, axis: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundAxisWorldDegrees(this, angle, axis, origin);
    };

    objectExtension.pp_rotateAroundAxisWorldRadians = function pp_rotateAroundAxisWorldRadians(angle: number, axis: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundAxisWorldRadians(this, angle, axis, origin);
    };

    // Rotate Around Axis Local

    objectExtension.pp_rotateAroundAxisLocal = function pp_rotateAroundAxisLocal(angle: number, axis: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundAxisLocal(this, angle, axis, origin);
    };

    objectExtension.pp_rotateAroundAxisLocalDegrees = function pp_rotateAroundAxisLocalDegrees(angle: number, axis: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundAxisLocalDegrees(this, angle, axis, origin);
    };

    objectExtension.pp_rotateAroundAxisLocalRadians = function pp_rotateAroundAxisLocalRadians(angle: number, axis: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundAxisLocalRadians(this, angle, axis, origin);
    };

    // Rotate Around Axis Object

    objectExtension.pp_rotateAroundAxisObject = function pp_rotateAroundAxisObject(angle: number, axis: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundAxisObject(this, angle, axis, origin);
    };

    objectExtension.pp_rotateAroundAxisObjectDegrees = function pp_rotateAroundAxisObjectDegrees(angle: number, axis: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundAxisObjectDegrees(this, angle, axis, origin);
    };

    objectExtension.pp_rotateAroundAxisObjectRadians = function pp_rotateAroundAxisObjectRadians(angle: number, axis: NumberArray, origin: NumberArray): void {
        return ObjectUtils.rotateAroundAxisObjectRadians(this, angle, axis, origin);
    };

    // Scale

    objectExtension.pp_scaleObject = function pp_scaleObject(scale: number | NumberArray): void {
    ...
    objectExtension.pp_convertPositionObjectToWorld = function pp_convertPositionObjectToWorld(position: NumberArray, resultPosition: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.convertPositionObjectToWorld(this, position, resultPosition);
    };

    objectExtension.pp_convertDirectionObjectToWorld = function pp_convertDirectionObjectToWorld(direction: NumberArray, resultDirection: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.convertDirectionObjectToWorld(this, direction, resultDirection);
    };

    objectExtension.pp_convertPositionWorldToObject = function pp_convertPositionWorldToObject(position: NumberArray, resultPosition: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.convertPositionWorldToObject(this, position, resultPosition);
    };

    objectExtension.pp_convertDirectionWorldToObject = function pp_convertDirectionWorldToObject(direction: NumberArray, resultDirection: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.convertDirectionWorldToObject(this, direction, resultDirection);
    };

    // Convert Vector Local World

    objectExtension.pp_convertPositionLocalToWorld = function pp_convertPositionLocalToWorld(position: NumberArray, resultPosition: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.convertPositionLocalToWorld(this, position, resultPosition);
    };

    objectExtension.pp_convertDirectionLocalToWorld = function pp_convertDirectionLocalToWorld(direction: NumberArray, resultDirection: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.convertDirectionLocalToWorld(this, direction, resultDirection);
    };

    objectExtension.pp_convertPositionWorldToLocal = function pp_convertPositionWorldToLocal(position: NumberArray, resultPosition: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.convertPositionWorldToLocal(this, position, resultPosition);
    };

    objectExtension.pp_convertDirectionWorldToLocal = function pp_convertDirectionWorldToLocal(direction: NumberArray, resultDirection: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.convertDirectionWorldToLocal(this, direction, resultDirection);
    };

    // Convert Vector Local Object

    objectExtension.pp_convertPositionObjectToLocal = function pp_convertPositionObjectToLocal(position: NumberArray, resultPosition: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.convertPositionObjectToLocal(this, position, resultPosition);
    };

    objectExtension.pp_convertDirectionObjectToLocal = function pp_convertDirectionObjectToLocal(direction: NumberArray, resultDirection: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.convertDirectionObjectToLocal(this, direction, resultDirection);
    };

    objectExtension.pp_convertPositionLocalToObject = function pp_convertPositionLocalToObject(position: NumberArray, resultPosition: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.convertPositionLocalToObject(this, position, resultPosition);
    };

    objectExtension.pp_convertDirectionLocalToObject = function pp_convertDirectionLocalToObject(direction: NumberArray, resultDirection: NumberArray = Vec3Utils.create()): NumberArray {
        return ObjectUtils.convertDirectionLocalToObject(this, direction, resultDirection);
    };

    // Convert Transform Object World

    objectExtension.pp_convertTransformObjectToWorld = function pp_convertTransformObjectToWorld(transform: NumberArray, resultTransform: NumberArray = Mat4Utils.create()): NumberArray {
        return ObjectUtils.convertTransformObjectToWorld(this, transform, resultTransform);
    };

    objectExtension.pp_convertTransformObjectToWorldMatrix = function pp_convertTransformObjectToWorldMatrix(transform: NumberArray, resultTransform: NumberArray = Mat4Utils.create()): NumberArray {
        return ObjectUtils.convertTransformObjectToWorldMatrix(this, transform, resultTransform);
    };

    objectExtension.pp_convertTransformObjectToWorldQuat = function pp_convertTransformObjectToWorldQuat(transform: NumberArray, resultTransform: NumberArray = Quat2Utils.create()): NumberArray {
        return ObjectUtils.convertTransformObjectToWorldQuat(this, transform, resultTransform);
    };

    objectExtension.pp_convertTransformWorldToObject = function pp_convertTransformWorldToObject(transform: NumberArray, resultTransform: NumberArray = Mat4Utils.create()): NumberArray {
        return ObjectUtils.convertTransformWorldToObject(this, transform, resultTransform);
    };

    objectExtension.pp_convertTransformWorldToObjectMatrix = function pp_convertTransformWorldToObjectMatrix(transform: NumberArray, resultTransform: NumberArray = Mat4Utils.create()): NumberArray {
        return ObjectUtils.convertTransformWorldToObjectMatrix(this, transform, resultTransform);
    };

    objectExtension.pp_convertTransformWorldToObjectQuat = function pp_convertTransformWorldToObjectQuat(transform: NumberArray, resultTransform: NumberArray = Quat2Utils.create()): NumberArray {
        return ObjectUtils.convertTransformWorldToObjectQuat(this, transform, resultTransform);
    };

    // Convert Transform Local World

    objectExtension.pp_convertTransformLocalToWorld = function pp_convertTransformLocalToWorld(transform: NumberArray, resultTransform: NumberArray = Mat4Utils.create()): NumberArray {
        return ObjectUtils.convertTransformLocalToWorld(this, transform, resultTransform);
    };

    objectExtension.pp_convertTransformLocalToWorldMatrix = function pp_convertTransformLocalToWorldMatrix(transform: NumberArray, resultTransform: NumberArray = Mat4Utils.create()): NumberArray {
        return ObjectUtils.convertTransformLocalToWorldMatrix(this, transform, resultTransform);
    };

    objectExtension.pp_convertTransformLocalToWorldQuat = function pp_convertTransformLocalToWorldQuat(transform: NumberArray, resultTransform: NumberArray = Quat2Utils.create()): NumberArray {
        return ObjectUtils.convertTransformLocalToWorldQuat(this, transform, resultTransform);
    };

    objectExtension.pp_convertTransformWorldToLocal = function pp_convertTransformWorldToLocal(transform: NumberArray, resultTransform: NumberArray = Mat4Utils.create()): NumberArray {
        return ObjectUtils.convertTransformWorldToLocal(this, transform, resultTransform);
    };

    objectExtension.pp_convertTransformWorldToLocalMatrix = function pp_convertTransformWorldToLocalMatrix(transform: NumberArray, resultTransform: NumberArray = Mat4Utils.create()): NumberArray {
        return ObjectUtils.convertTransformWorldToLocalMatrix(this, transform, resultTransform);
    };

    objectExtension.pp_convertTransformWorldToLocalQuat = function pp_convertTransformWorldToLocalQuat(transform: NumberArray, resultTransform: NumberArray = Quat2Utils.create()): NumberArray {
        return ObjectUtils.convertTransformWorldToLocalQuat(this, transform, resultTransform);
    };

    // Convert Transform Object Local

    objectExtension.pp_convertTransformObjectToLocal = function pp_convertTransformObjectToLocal(transform: NumberArray, resultTransform: NumberArray = Mat4Utils.create()): NumberArray {
        return ObjectUtils.convertTransformObjectToLocal(this, transform, resultTransform);
    };

    objectExtension.pp_convertTransformObjectToLocalMatrix = function pp_convertTransformObjectToLocalMatrix(transform: NumberArray, resultTransform: NumberArray = Mat4Utils.create()): NumberArray {
        return ObjectUtils.convertTransformObjectToLocalMatrix(this, transform, resultTransform);
    };

    objectExtension.pp_convertTransformObjectToLocalQuat = function pp_convertTransformObjectToLocalQuat(transform: NumberArray, resultTransform: NumberArray = Quat2Utils.create()): NumberArray {
        return ObjectUtils.convertTransformObjectToLocalQuat(this, transform, resultTransform);
    };

    objectExtension.pp_convertTransformLocalToObject = function pp_convertTransformLocalToObject(transform: NumberArray, resultTransform: NumberArray = Mat4Utils.create()): NumberArray {
        return ObjectUtils.convertTransformLocalToObject(this, transform, resultTransform);
    };

    objectExtension.pp_convertTransformLocalToObjectMatrix = function pp_convertTransformLocalToObjectMatrix(transform: NumberArray, resultTransform: NumberArray = Mat4Utils.create()): NumberArray {
        return ObjectUtils.convertTransformLocalToObjectMatrix(this, transform, resultTransform);
    };

    objectExtension.pp_convertTransformLocalToObjectQuat = function pp_convertTransformLocalToObjectQuat(transform: NumberArray, resultTransform: NumberArray = Quat2Utils.create()): NumberArray {
