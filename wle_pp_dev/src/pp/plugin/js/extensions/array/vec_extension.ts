...
export function initVecExtensionProtoype(): void {
    ...
    vecExtension.vec_zero = function vec_zero(this: Vector): Vector {
        return VecUtils.zero(this);
    };

    vecExtension.vec_isZero = function vec_isZero(this: Vector, epsilon: number = 0): boolean {
        return VecUtils.isZero(this, epsilon);
    };

    vecExtension.vec_scale = function vec_scale<T extends Vector>(this: Vector, value: number, out?: T): T {
        return VecUtils.scale(this, value, out);
    };

    vecExtension.vec_round = function vec_round<T extends Vector>(this: Vector, out?: T): T {
        return VecUtils.round(this, out);
    };

    vecExtension.vec_floor = function vec_floor<T extends Vector>(this: Vector, out?: T): T {
        return VecUtils.floor(this, out);
    };

    vecExtension.vec_ceil = function vec_ceil<T extends Vector>(this: Vector, out?: T): T {
        return VecUtils.ceil(this, out);
    };

    vecExtension.vec_clamp = function vec_clamp<T extends Vector>(this: Vector, start: number, end: number, out?: T): T {
        return VecUtils.clamp(this, start, end, out);
    };

    vecExtension.vec_equals = function vec_equals(this: Vector, vector: Vector, epsilon: number = 0): boolean {
        return VecUtils.equals(this, vector, epsilon);
    };

    vecExtension.vec_toString = function vec_toString(this: Vector, decimalPlaces?: number): string {
        return VecUtils.toString(this, decimalPlaces);
    };

    vecExtension.vec_log = function vec_log(this: Vector, decimalPlaces: number = 4): void {
        return VecUtils.log(this, decimalPlaces);
    };

    vecExtension.vec_error = function vec_error(this: Vector, decimalPlaces: number = 4): void {
        return VecUtils.error(this, decimalPlaces);
    };

    vecExtension.vec_warn = function vec_warn(this: Vector, decimalPlaces: number = 4): void {
