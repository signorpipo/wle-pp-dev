WL.registerComponent('locomotion-draft-2', {
    ...
    _setupCollisionCheckParams() {
        ...
        this._myCollisionCheckParams.myGroundPopOutDistanceFromFeet = 0.1;
        this._myCollisionCheckParams.myGroundPopOutDistanceFromHead = 0.1;
        ...
        this._myCollisionCheckParams.mySlidingFlickerPreventionCheckAnywayCounter = 4;
